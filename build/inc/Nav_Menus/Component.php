 ...
 * * `wp__lhtbp()->is_primary_nav_menu_active()`
 * * `wp__lhtbp()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	const PRIMARY_NAV_MENU_SLUG = 'header';
	/**
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			[
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Header', '_lhtbp' ),
			]
		);
	}
	/**
